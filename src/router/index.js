	...
	routes: [{
		...
		children: [
			...
			// 课程支付成功
			{
				...
				component: resolve => require(['../components/class/InterviewDetail.vue'], resolve),

			}, {
				// 培训详情页面
				path: 'TrainDetail/:id',
				name: 'TrainDetail',
				component: resolve => require(['../components/class/TrainDetail.vue'], resolve),

			}, {
				// 完善个人信息页面
				path: 'FillInfo/:id',
				name: 'FillInfo',
				component: resolve => require(['../components/class/FillInfo.vue'], resolve),

			}, {
				// 会议签到
				path: 'ConferenceSign/:id',
				name: 'ConferenceSign',
				component: resolve => require(['../components/class/ConferenceSign.vue'], resolve),

			}, {
				// 会议签到成功
				path: 'SignSuccess',
				name: 'SignSuccess',
				component: resolve => require(['../components/class/Sign/SignSuccess.vue'], resolve),
				...
				path: 'AboutUs/:id',
				name: 'AboutUs',
				component: resolve => require(['../components/user/AboutUs.vue'], resolve),
			}, {
				// 会员帮助中心页面
				path: 'MembershipHelp',
				name: 'MembershipHelp',
				component: resolve => require(['../components/user/MembershipHelp.vue'], resolve),
			}
		]
	}],
	scrollBehavior(to, from, savedPosition) {
		if(to.name != 'sysmessage') {
			if(savedPosition) {
