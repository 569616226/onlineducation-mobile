...
let wechatConfig = {
	//第一个为设置网页授权回调地址
	wechatRedirectUrl: "https://wx.qatest.elinkport.com",
	appId: "wxbe276e2b5a3cf864",
	appSecret: "7ad842735e8055571a6c8db86ea50ab3",
}
let opn = require('opn')
...
//授权后跳转
app.get('/static/wechatOauth/oauth/redirect', (req, res) => {
	let params = req.query
